    ...
    try:
        ...
        if not audio_data or audio_data.strip() == '':
            ...
            return build_audio_info(
                ...
                success=True, empty=True, message='录音为空，已创建空文件', student_folder=student_folder
            )
        ...
        if not audio_data.startswith('data:audio/'):
            ...
            if audio_data.strip():
                ...
                return build_audio_info(
                    wav_filepath, wav_relative_path, student_name, safe_name,
                    success=True, empty=True, message='音频数据格式错误，已创建空文件', student_folder=student_folder
                )
        ...
        try:
            ...
            if success:
                ...
                return build_audio_info(
                    wav_filepath, wav_relative_path, student_name, safe_name,
                    success=True, empty=True, message='音频转换失败，已创建空文件',
            ...
            return build_audio_info(
                wav_filepath, wav_relative_path, student_name, safe_name,
                success=True, empty=True, message='音频处理异常，已创建空文件',
        ...
        try:
            if wav_filepath and wav_filename:
                ...
                return build_audio_info(
                    ...
                    success=True, empty=True, message='系统错误，已创建空文件',
